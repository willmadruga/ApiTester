...
module.exports = {
  ...
  show_usage : function() {
    ...
    console.log('#                                                                      #'.bgBlack.white);
    console.log('# Usage: node tester.js <server> <version> <directory_with_test_cases> #'.bgBlack.white);
    console.log('# i.e.: node tester.js localhost mock test-cases/tool-tests            #'.bgBlack.white);
    console.log('#                                                                      #'.bgBlack.white);
