...
module.exports = {
  ...
  get_payload : function(file) {
    ...
    // just need to clean new-line from file...
              ...
              if (err != undefined) {
                ...
                parse_xml(res_data, function (err, parsed_server_res) {
                    if (err != undefined) {
                      ...
                      try {
                        assert.equal(parsed_server_res.Response.ResponseCode[0], parsed_expected_res.Response.ResponseCode[0]);
                        assert.equal(parsed_server_res.Response.ErrorMessage[0], parsed_expected_res.Response.ErrorMessage[0]);
                        ...
                        console.log(colors.red('Expected:' + err.expected));
